...
// 下查詢資料庫語法 --------------------------------------------------------
$sql = "SELECT * FROM `big_patients` WHERE `CID` ='{$un}'";// && day1 AND day2 BETWEEN $datetime1 AND $datetime2";// 條件1:username / 條件2:查詢最早日期至最近日期
//echo $sql;
//----------------設定UTF8------------------------------------------------
...
<body onload="setTimeout('xxx()', 1440000)"><!--24分鐘內沒動作自動導入登出端，滑鼠移動就重新計算倒數登出秒數-->
    ...
    <div class="row">
        <div class="col-md-12">
        <h1>All cases - 全部個案資料</h1>
        <br><a href="caregiver.php" id="#textA" class="btn btn-primary">return 返回</a>
        <br>
                <table class="table table-striped">
                <thead class="thead-dark">
                <tr>
                  <th width="8%" scope="col">date / 日期</th>
                  <th width="12%" scope="col">Case name / 編號</th>
