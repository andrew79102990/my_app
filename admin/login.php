      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-sm-offset-4">
          	<h1>Background login<br>後台登入</h1>
            <form class="login">
              <div class="form-group">
                <label for="username">username 帳號</label>
                <input type="text" class="form-control" id="username" name="username" placeholder="請輸入帳號" required pattern="[0-9a-zA-Z]{7,12}">
              </div>
              <div class="form-group">
                <label for="password">password 密碼</label>
                <input type="password" class="form-control" id="password" name="password" placeholder="請輸入密碼" required pattern="[0-9a-zA-Z]{7,12}">
              </div>
              <button type="submit" class="btn btn-default">
              Login 登入
              </button>
              <a href="get.php">forget password 忘記密碼</a>
            </form>
          </div>
        </div>
      </div>
