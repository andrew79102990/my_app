...
@$jurisdictions = $_POST['jurisdictions'];  
@$MH = $_POST['MH'];
@$AH = $_POST['AH'];
@$OH = $_POST['OH'];
@$BT = $_POST['BT'];
...
//-----------------------------------------------------------------------------------------------
//@$add_result = add_article($_POST['username'], $_POST['name'], $_POST['datetime'], $_POST['jurisdictions'],$A, $_POST['MH'], $_POST['AH'], $_POST['OH'],$_POST['BT'], $_POST['HR'], $_POST['RR'], $_POST['SBP'],$_POST['DBP'], $_POST['Stool'], $_POST['SPO2'], $_POST['E'],$_POST['V'], $_POST['M'], $_POST['GCS'], $_POST['MP'],$_POST['Totbody'], $_POST['Ifood'], $_POST['Bathing'], $_POST['digestion'],$_POST['DHRW'], $_POST['TM'], $_POST['CHA']);
    ...
    <div class="content">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-10">
            <form  method="POST" action="../php/add_big.php">
              
              <!--<div class="form-group" id='textA'>
                <label for="username" >帳號/username</label>
                <input type="text" style="font-size:27px" class="form-control" id="username" name="username" placeholder="請輸入7-12個英數字的帳號" required pattern="[0-9a-zA-Z]{7,12}">
              </div>-->
              
              <!--<div class="form-group" id='textA'>
                <label for="name">被照顧者長照編號Patient number/<br>一般會員username</label>
                <input type="text" style="font-size:27px" class="form-control" id="name" name="name" placeholder="請輸入長照編號Patient number or 會員帳號username">
              </div>-->
              
			  <!--<div class="form-group" id='textA'>
                <label for="datetime">日期/datetime</label>
                <input type="date" style="font-size:27px" class="form-control" id="datetime" name="datetime"  required>
              </div>-->

			  <!--<div class="form-group" id='textA'>
                <label for="jurisdictions">區域/jurisdictions</label>
                <input type="text" style="font-size:27px" class="form-control" id="jurisdictions" name="jurisdictions" placeholder="請輸入區域" required pattern="[0-9a-zA-Z]">
              </div>-->
